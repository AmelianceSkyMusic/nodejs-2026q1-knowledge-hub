...
describe('RBAC - Articles (e2e)', () => {
	...
	describe('Viewer role', () => {
		it('should allow GET all articles', async () => {
			...
			const response = await request.get(articlesRoutes.getAll).set(viewerHeaders);
	...
	describe('Editor role', () => {
		it('should allow GET all articles', async () => {
			...
			const response = await request.get(articlesRoutes.getAll).set(editorHeaders);
	...
	describe('Admin role', () => {
		it('should allow full CRUD on articles', async () => {
			...
			// GET all
			const getAllResponse = await request.get(articlesRoutes.getAll).set(adminHeaders);
