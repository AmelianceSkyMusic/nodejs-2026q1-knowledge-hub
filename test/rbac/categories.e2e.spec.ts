...
describe('RBAC - Categories (e2e)', () => {
	...
	describe('Viewer role', () => {
		it('should allow GET all categories', async () => {
			...
			const response = await request.get(categoriesRoutes.getAll).set(viewerHeaders);
	...
	describe('Editor role', () => {
		it('should allow GET all categories', async () => {
			...
			const response = await request.get(categoriesRoutes.getAll).set(editorHeaders);
	...
	describe('Admin role', () => {
		it('should allow full CRUD on categories', async () => {
			...
			// GET all
			const getAllResponse = await request.get(categoriesRoutes.getAll).set(adminHeaders);
