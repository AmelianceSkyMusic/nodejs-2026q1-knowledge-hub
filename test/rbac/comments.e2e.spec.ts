...
describe('RBAC - Comments (e2e)', () => {
	...
	describe('Viewer role', () => {
		...
		it('should deny POST comment', async () => {
			...
			const response = await request.post(commentsRoutes.create).set(viewerHeaders).send({
	...
	describe('Editor role', () => {
		...
		it('should allow POST own comment', async () => {
			...
			const response = await request.post(commentsRoutes.create).set(editorHeaders).send({
		...
		it("should deny DELETE other's comment", async () => {
			...
			const createResponse = await request.post(commentsRoutes.create).set(adminHeaders).send({
