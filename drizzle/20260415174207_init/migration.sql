...
CREATE TABLE "article_to_tags" (
	"A" uuid,
	"B" uuid,
	CONSTRAINT "article_to_tags_pkey" PRIMARY KEY("A","B")
);
...
ALTER TABLE "article_to_tags" ADD CONSTRAINT "article_to_tags_A_articles_id_fkey" FOREIGN KEY ("A") REFERENCES "articles"("id") ON DELETE CASCADE;--> statement-breakpoint
ALTER TABLE "article_to_tags" ADD CONSTRAINT "article_to_tags_B_tags_id_fkey" FOREIGN KEY ("B") REFERENCES "tags"("id") ON DELETE CASCADE;--> statement-breakpoint
